...
public class VideoNEW extends JkDefaultEntity {
    ...
    @JkEntityField(index = 6, collectionType = CategoryNW.class)
    private Set<CategoryNW> categories;
    ...
    public static VideoNEW createFromPath(Path path) throws Exception {
        VideoNEW video = new VideoNEW();
    ...
    public Set<CategoryNW> getCategories() {
        return categories;
    }
    ...
    public void addCategories(Collection<CategoryNW> categories) {
