...
public class CutVideoPane2 extends BorderPane implements Closeable {

    private static final Logger LOG = LoggerFactory.getLogger(CutVideoPane2.class);

    private final FxModel model = FxModel.getModel();

    private JfxVideoPlayer videoPlayer;

    public CutVideoPane2(Video video) {
